-- =====================================================================
-- Confirmacao ao INDICADOR (garantida) + texto mais claro.
-- Comendador: "segue para o 2o padrinho e o Mestre" (ind_registrada).
-- Mestre/Grao-Mestre (sem 2o padrinho): "enviada para a aprovacao de
-- {aprovador}" (ind_registrada_unico) - {aprovador} sem o sufixo do nucleo.
-- Re-cria _subst, o modelo e o gatilho (idempotente). 100% ASCII.
-- =====================================================================

-- 1) _subst com {aprovador} (e as demais variaveis ja existentes)
...
-- 2) Texto claro da confirmacao (aprovacao unica)
...
('ind_registrada_unico','Indicacao - registrada (aprovacao unica)','Indicacao registrada','Indica&ccedil;&atilde;o registrada',
 '<p>Ol&aacute;, {nome}!</p><p>Recebemos a sua indica&ccedil;&atilde;o de <b>{indicado}</b>. Ela foi <b>enviada para a aprova&ccedil;&atilde;o de {aprovador}</b>.</p><p>Voc&ecirc; ser&aacute; avisado assim que houver a decis&atilde;o.</p>',
